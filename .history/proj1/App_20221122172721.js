...
import { StyleSheet, Alert, Button, Text, View, ImageBackground} from 'react-native';
...
//returning the view
  return (
    <View style={styles.container}>
     <ImageBackground source={require('./assets/bg.png')} style={{width: '100%', height: '100%',display: 'fixed',
